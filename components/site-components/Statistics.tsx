...
const Statistics = () => {
  return (
    <section className="mt-14 w-full lg:mt-0 py-4 px-4 lg:py-24">
      <div className="mx-auto lg:max-w-6xl sm:px-10 md:px-16 grid lg:grid-cols-2 lg:items-center gap-10 ">
        <div className="flex aspect-square lg:aspect-auto lg:h-[36rem] relative">
          ...
          <div className="absolute right-8 sm:-right-4 -top-8 bg-black text-white p-6 rounded-sm text-sm shadow-md">
        ...
        <div className="flex flex-col space-y-8 sm:space-y-10 lg:text-left max-w-2xl md:max-w-3xl">
          ...
          Join others in exploring the world of technology! In our first camp, 35 students were trained — you could be next. You can also make a difference by supporting a 
          child who wants to join but can not afford the registration fee.
          </p>
          ...
          <div className="flex flex-row items-center lg:justify-start gap-2 lg:gap-4 w-full">
            <Link
              href="https://docs.google.com/forms/d/e/1FAIpQLSfyc4wFl4mANFM1cmAEgwy7Df_cXiPcYnUBTxaTyeTFwfF-mg/viewform"
