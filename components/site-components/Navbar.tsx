  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 lg:gap-12 text-[15px]">
        <Link href="/" className="text-black">Home</Link>
        {/* Updated Donate link */}
        <Link href="/donate" className="text-black">
          Donate
        </Link>
      </div>
      <Link
        className="h-11 rounded-full px-8"
        href="https://docs.google.com/forms/d/e/1FAIpQLSfyc4wFl4mANFM1cmAEgwy7Df_cXiPcYnUBTxaTyeTFwfF-mg/viewform?usp=header"
        target="_blank"
      >
        Apply
      </Link>
