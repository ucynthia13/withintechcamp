...
const OurTeam = () => {
  return (
    <section className="mt-14 w-full lg:mt-0 py-4 lg:py-24">
      <div className="mx-auto lg:max-w-7xl px-6 lg:px-12 flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 justify-items-center">
          {trainers.map((trainer, index) => (
            <div
              key={index}
              className="relative w-42 sm:w-52 aspect-[3/4] bg-cover bg-center rounded-sm shadow-md flex items-end hover:shadow-md cursor-pointer"
              style={{ backgroundImage: `url('${trainer.image}')` }}
            >
              <div className="relative bg-white/90 p-2 rounded-sm text-center mx-auto w-11/12 shadow-lg mb-5">
