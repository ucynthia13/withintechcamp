...
const Statistics = () => {
  return (
    <section className="py-4 px-4 lg:py-24">
      <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 grid lg:grid-cols-2 lg:items-center gap-10 ">
        <div className="flex aspect-square lg:aspect-auto lg:h-[36rem] relative">
          <div className="relative w-4/5 h-[68%] rounded-sm overflow-clip">
            <Image
              src="/images/grad.jpg"
          ...
          <div className="absolute -left-20 bottom-0 h-[calc(100%-220px)] w-3/5 rounded-xl overflow-clip ">
            <Image
              src="/images/ceo.jpg"
          ...
          <div className="absolute right-10 -top-8 bg-black text-white p-6 rounded-sm text-sm shadow-md">
